...
export default function HowToBuy() {
  ...
  const howToBuyData = [
    ...
    },
    {
      ...
      hsDesc: "Connect to Raydium or Jupiter and in Google Chrome or on the browser inside your  Phantom app. Connect your wallet. Paste the VCAT token token address into search, select VCAT and confirm. When your wallet prompts you for a wallet signature, sign.",
    },
  ];
